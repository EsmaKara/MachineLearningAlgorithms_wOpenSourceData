...
plt.ylabel('Gerçek')
plt.tight_layout()
plt.savefig('base_model_confusion_matrix.png', dpi=300)
...
sns.heatmap(best_cm, annot=True, fmt='d', cmap='Blues',
            xticklabels=target_names,
            yticklabels=target_names)
plt.title('Optimize Edilmiş Model Confusion Matrix')
plt.xlabel('Tahmin Edilen')
plt.ylabel('Gerçek')
plt.tight_layout()
plt.savefig('optimized_model_confusion_matrix.png', dpi=300)
